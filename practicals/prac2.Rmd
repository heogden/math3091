---
title: 'MATH3012 worksheet 2: Multiple linear regression'
author: ""
date: ""
output: pdf_document
fontsize: 12pt
...
plot(nitric_lm2)
```
It produces four plots. If the model is good,
the first plot should
not show any systematic pattern,  the residuals should be random.
