---
title: 'MATH3012, Worksheet 3: Linear models with both continuous and categorical covariates'
author: "Helen Ogden"
date: ""
output: pdf_document
header-includes:
...
because $s_i$ can only take two possible values: male or female.  By setting
```{r}
options(contrasts=c("contr.treatment", "contr.poly"))
```

we force the first of the two possible values of  $\alpha(s_i)$ to be zero.
