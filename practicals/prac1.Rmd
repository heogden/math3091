...
in MATH3012. In this lab, we will review some basic
`R` commands and best practices, and download all
the datasets needed for later worksheets.

`RStudio` is one *interface* to `R`:
...
## Preparing for the MATH3012 computer labs
...
for the computer labs throughout the course.
