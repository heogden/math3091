...
individuals from the 1984 General Social Survey, as shown in Table \ref{tab:job}.
...
\bottomrule
\end{tabular}
\caption{\label{tab:job} The \texttt{job} dataset}
\end{table}
...
\bottomrule
\end{tabular}
\caption{\label{tab:lymphoma} The \texttt{lymphoma} dataset}
\end{table}
