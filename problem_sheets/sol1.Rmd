...
\[\hat \beta_1 = \frac{\sum_{i=1}^n x_i y_i - n \hat \beta_0 \bar x}{\sum_{i=1}^n x_i^2}\]
Substituting $\hat \beta_0$, we get
\[\hat \beta_1 = \frac{\sum_{i=1}^n x_i y_i - n (\bar y - \hat \beta_1 \bar x)\bar x}{\sum_{i=1}^n x_i^2},\]
and rearranging for $\hat \beta_1$ gives
