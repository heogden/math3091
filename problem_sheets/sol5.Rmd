...
= \exp\left(-\log(\sum_{j=1}^n e^{\hat \beta_2 x_j}) + \hat \beta_2 x_i\right)
= \frac{e^{\hat \beta_2 x_i}}{\sum_{j=1}^n e^{\hat \beta_2 x_j}}.\]
\eenum
...
\[p_1 - p_2 = \beta_2 = \log(1 - p) - \log(p) = - \log \left(\frac{p}{1-p} \right)
  = - \text{logit} (p),\]
