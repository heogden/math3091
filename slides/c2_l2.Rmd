...
canonical parameter $\theta_i = p_i$, and with no scale parameter
($a(\phi) = 1$).
...
to the likelihood $L(\bm{\beta})$ for $\bm{\beta}$ by substituting
...
the likelihood substantially, and look at maximum likelihood estimation
