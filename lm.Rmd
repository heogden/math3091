...
```
```{example, catlm, name = "A categorical explanatory variable"}
...
as they only affect the distribution through the combination $\beta_1 + \beta_{j}$.
